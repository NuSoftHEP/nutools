...
BEGIN { %dir_list = (
  ...
  "G4MATERIALS" => "Geant4::G4materials.so",
  "G4MODELING" => "Geant4::G4modeling.so",
  "G4PARTICLES" => "Geant4::G4particles.so",
  "G4PERSISTENCY" => "Geant4::G4persistency.so",
  "G4PHYSICSLISTS" => "Geant4::G4physicslists.so",
